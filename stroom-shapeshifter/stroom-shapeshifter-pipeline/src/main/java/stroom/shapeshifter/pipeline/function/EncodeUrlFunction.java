...
/** {@code encode-url}: as {@code stroom.pipeline.xsltfunctions.EncodeUrl}. */
public final class EncodeUrlFunction extends StroomFunction {

    public EncodeUrlFunction() {
        super("encode-url", Signature.of(Kind.STRING, Kind.STRING), Purity.PURE);
    }
    ...
    public FunctionCall bind(final FunctionContext context) {
        return arguments -> {
            ...
            try {
                return TypedValue.of(URLEncoder.encode(url, StandardCharsets.UTF_8));
