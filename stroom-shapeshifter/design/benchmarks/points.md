...
*Points 36 to 41 are the set: the floor and the five phases. `win_sec_strict` keeps the
63-template configuration throughout and is the control for point 41's `win_sec`.*

Points 36 to 41, in one run, the benchmark's own fidelity (`full`): the floor and the five
...
```
engine-bench-points.sh full 597274d25e f95a7287e1 a2fd4cf9f3 815caf7961 ce776c7c72 36e5a79c3e
```
