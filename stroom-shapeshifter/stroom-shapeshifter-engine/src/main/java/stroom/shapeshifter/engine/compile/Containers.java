 ...
 * templates referred to — and the structure check passes through the containers it does not
 * judge; each walk used to carry its own list of container instructions, with
