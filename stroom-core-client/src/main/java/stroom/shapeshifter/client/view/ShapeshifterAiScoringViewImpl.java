...
public class ShapeshifterAiScoringViewImpl
        extends ViewWithUiHandlers<ShapeshifterAiSettingsUiHandlers>
        implements ShapeshifterAiScoringView {
    ...
    @Inject
    public ShapeshifterAiScoringViewImpl(final Binder binder) {
    ...
    public interface Binder extends UiBinder<Widget, ShapeshifterAiScoringViewImpl> {
