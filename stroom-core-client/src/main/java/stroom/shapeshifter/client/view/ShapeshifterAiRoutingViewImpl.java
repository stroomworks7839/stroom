...
public class ShapeshifterAiRoutingViewImpl
        extends ViewWithUiHandlers<ShapeshifterAiSettingsUiHandlers>
        implements ShapeshifterAiRoutingView {
    ...
    @Inject
    public ShapeshifterAiRoutingViewImpl(final Binder binder) {
    ...
    public interface Binder extends UiBinder<Widget, ShapeshifterAiRoutingViewImpl> {
