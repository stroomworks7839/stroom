...
public interface ShapeshifterGinjector {

    AsyncProvider<ShapeshifterPlugin> getShapeshifterPlugin();

    AsyncProvider<ShapeshifterPresenter> getShapeshifterPresenter();
}
