...
public class CoreModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        install(new stroom.activity.impl.dao.ActivityDaoModule());
        install(new stroom.ai.impl.dao.AiDaoModule());
        install(new stroom.analytics.impl.AnalyticsModule());
        install(new stroom.analytics.impl.dao.AnalyticsDaoModule());
        install(new stroom.annotation.impl.AnnotationModule());
        install(new stroom.annotation.impl.dao.AnnotationDaoModule());
        ...
        install(new stroom.cluster.lock.impl.dao.ClusterLockModule());
        ...
        install(new stroom.docstore.impl.DocFinderModule());
        install(new stroom.docstore.impl.dao.DocStoreDbPersistenceModule());
        install(new stroom.dropwizard.common.DropwizardModule());
        install(new stroom.explorer.impl.ExplorerFavModule());
        install(new stroom.explorer.impl.dao.ExplorerFavDbModule());
        install(new stroom.explorer.impl.dao.TabSessionDbModule());
        ...
        install(new stroom.explorer.impl.dao.ExplorerDaoModule());
        ...
        install(new stroom.node.impl.dao.NodeDaoModule());
        ...
        install(new stroom.processor.impl.dao.ProcessorDaoModule());
        ...
        install(new stroom.shapeshifter.ai.impl.db.ShapeshifterAiDaoModule());
        ...
        install(new stroom.storedquery.impl.dao.StoredQueryDaoModule());
